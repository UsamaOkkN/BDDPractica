...
fk_tipoProducto varchar(100) not null, oferta int not null default 0, descripcio varchar(500), foto varchar(200), stockMig int not null );
...
insert into llista select pk_idProducto, (stockMig-stock + (stockMig-stock)*0,10) from Producto where stock<stockMig;
select * from llista;
End$$
delimiter ;
